...
do_configure() {
    cp ${DEPLOY_DIR_IMAGE}/${OVERLAY_PREFIX}-sd-overlay.dtbo  ${WORKDIR}/sd-overlay.dtbo
    cp ${DEPLOY_DIR_IMAGE}/${OVERLAY_PREFIX}-mmc-overlay.dtbo  ${WORKDIR}/mmc-overlay.dtbo
}
