...
```plain
ERROR: u-boot-1_2021.10+git-r0 do_package: Error executing a python function in exec_func_python() autogenerated:
 ...
 *** 0002:perform_packagecopy(d)
     0003:
File: '/__w/meta-solidrun-arm-rzg2lc/meta-solidrun-arm-rzg2lc/build/../poky/meta/classes-global/package.bbclass', lineno: 363, function: perform_packagecopy
 ...
 *** 0526:            raise CalledProcessError(retcode, process.args,
     ...
     0529:
     0530:
Exception: subprocess.CalledProcessError: Command 'tar --exclude=./sysroot-only -cf - -C /__w/meta-solidrun-arm-rzg2lc/meta-solidrun-arm-rzg2lc/build/tmp/work/rzg2ul_sr_som-poky-linux/u-boot/2021.10+git/image -p -S . | tar -xf - -C /__w/meta-solidrun-arm-rzg2lc/meta-solidrun-arm-rzg2lc/build/tmp/work/rzg2ul_sr_som-poky-linux/u-boot/2021.10+git/package' returned non-zero exit status 2.

Subprocess output:
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot-rzg2ul-hummingboard-2021.10+git-r0.bin
couldn't allocate absolute path for 'u-boot-rzg2ul-hummingboard-2021.10+git-r0.bin'.
tar: ./boot/u-boot-rzg2ul-hummingboard-2021.10+git-r0.bin: Cannot open: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot.bin-rzg2ul-hummingboard
couldn't allocate absolute path for 'u-boot.bin-rzg2ul-hummingboard'.
tar: ./boot/u-boot.bin-rzg2ul-hummingboard: Cannot create symlink to ‘u-boot-rzg2ul-hummingboard-2021.10+git-r0.bin’: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot.bin
couldn't allocate absolute path for 'u-boot.bin'.
tar: ./boot/u-boot.bin: Cannot create symlink to ‘u-boot-rzg2ul-hummingboard-2021.10+git-r0.bin’: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0
couldn't allocate absolute path for 'u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0'.
tar: ./etc/u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0: Cannot open: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard
couldn't allocate absolute path for 'u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard'.
tar: ./etc/u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard: Cannot create symlink to ‘u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0’: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot-initial-env-rzg2ul-hummingboard
couldn't allocate absolute path for 'u-boot-initial-env-rzg2ul-hummingboard'.
tar: ./etc/u-boot-initial-env-rzg2ul-hummingboard: Cannot create symlink to ‘u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0’: Bad address
got *at() syscall for unknown directory, fd 4
unknown base path for fd 4, path u-boot-initial-env
couldn't allocate absolute path for 'u-boot-initial-env'.
tar: ./etc/u-boot-initial-env: Cannot create symlink to ‘u-boot-initial-env-rzg2ul-sr-som-rzg2ul-hummingboard-2021.10+git-r0’: Bad address
